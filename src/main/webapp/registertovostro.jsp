...
<head>
    ...
    <script type="text/javascript" src="/WebAppGym/gym/js/reg.js"></script>

</head>
<script>

var phone_server = '<%=session.getAttribute("phone") %>'
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <p class="mb-4">Enter your registered mobile number </p>
                    <div id="regFrom" class="mb-3" >
                        ...
                        <button id="regBtn" class="btn btn-primary d-grid w-100">Register</button>
                    </div>
