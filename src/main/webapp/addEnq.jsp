...
<head>
    ...
    <script type="text/javascript" src="/WebAppGym/gym/js/addEnq.js"></script>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Home/</span> Add Inquiry</h4>
                            ...
                            <div id="regFrom" class="mb-3" >
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-company2" class="input-group-text" ><i class="fa fa-phone fa-lg"></i></span>
                                ...
                                <button id="addQueryBtn" class="btn btn-primary d-grid w-100">Add</button>
                            </div>
