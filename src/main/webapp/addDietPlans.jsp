...
<head>
  ...
  <script type="text/javascript" src="/WebAppGym/gym/js/addDietPlans.js"></script>
    ...
    <div class="layout-page">
      ...
      <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <!-- Bootstrap modals -->
          <jsp:include page="dietPlanAdd.jsp"/>
          <!--/ Bootstrap modals -->
          <div class="card">
            ...
            <div id="subTableDv" class="table-responsive text-nowrap">
              <table id="subtable" class="table" style="table-layout: fixed;width: 100%;">
                <thead>
                <tr>
