...
<div class="card mb-4">
        ...
        <div class="row gy-3">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <!-- Extra Large Modal -->
                <div class="modal fade" id="expenseEditPopup" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">

                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel4">Edit Expenses</h5>
                                <button
                                        type="button"
                                        class="btn-close"
                        ...
                        <%--<div class="modal-body">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label class="form-label" for="expEditDate">Date</label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="expenseEditType">Expense </label>
                                    <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-company2" class="input-group-text" ><i class="bx bx-purchase-tag"></i></span>

                                        <select id="expenseEditType" class="select2 form-select">
                                            <option value="">Select</option>

                                        </select>
                                    </div>
                                </div>
                                <div class="mb-3" id="expOtherEditDiv">
                                    <label class="form-label" for="expOtherEditDesc">Description </label>
                                    <div class="input-group input-group-merge">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="expEditAmount">Amount</label>
                                    <div class="input-group input-group-merge">
