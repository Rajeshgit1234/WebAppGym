...
<head>
    ...
    <script type="text/javascript" src="/WebAppGym/gym/js/mapDiet.js"></script>
...
<script>
    ...
    var dietPlans = <%=session.getAttribute("dietPlans") %>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="regFrom" class="mb-3" >
                                ...
                                <label class="form-label" for="usersList">Diet Plans </label>
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-company2" class="input-group-text" ><i class="fa fa-cc-amex fa-lg"></i></span>

                                    <select id="dietList" class="select2 form-select">
                                        <option value="0">Select</option>
                                ...
                                <button id="linkSub" class="btn btn-primary d-grid w-100">Assign</button>
                            </div>
